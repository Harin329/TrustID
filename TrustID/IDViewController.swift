...
class IDViewController: UIViewController {
    ...
    private func retrievePeripheral() {
        ...
        let connectedPeripherals: [CBPeripheral] = (centralManager.retrieveConnectedPeripherals(withServices: [InfoSent.serviceUUID]))
        ...
        if let connectedPeripheral = connectedPeripherals.last {
            ...
            centralManager.scanForPeripherals(withServices: [InfoSent.serviceUUID],
    ...
    private func cleanup() {
        ...
        for service in (discoveredPeripheral.services ?? [] as [CBService]) {
            for characteristic in (service.characteristics ?? [] as [CBCharacteristic]) {
                if characteristic.uuid == InfoSent.characteristicUUID && characteristic.isNotifying {
    ...
    @IBAction func SendBluetooth(_ sender: Any) {
        if !peripheralManager.isAdvertising {
            peripheralManager.startAdvertising([CBAdvertisementDataServiceUUIDsKey: [InfoSent.serviceUUID]])
        } else {
...
extension IDViewController: CBCentralManagerDelegate {
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        peripheral.discoverServices([InfoSent.serviceUUID])
    }
...
extension IDViewController: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral, didModifyServices invalidatedServices: [CBService]) {
        ...
        for service in invalidatedServices where service.uuid == InfoSent.serviceUUID {
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        for service in peripheralServices {
            peripheral.discoverCharacteristics([InfoSent.characteristicUUID], for: service)
        }
    }
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in serviceCharacteristics where characteristic.uuid == InfoSent.characteristicUUID {
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateNotificationStateFor characteristic: CBCharacteristic, error: Error?) {
        ...
        guard characteristic.uuid == InfoSent.characteristicUUID else { return }
...
extension IDViewController: CBPeripheralManagerDelegate {
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, central: CBCentral, didSubscribeTo characteristic: CBCharacteristic) {
        ...
        // Get the data
        dataToSend = String("testinggggggggggg").data(using: .utf8)!
